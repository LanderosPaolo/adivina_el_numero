...
# El número elegido sera de manera aleatoria entre 1 y 10
numero = randint(1,10)
...
if(jugar == "si"):
    ...
    while intentos > 0:
        ...
        numero_jugador = int(input('- Entre los números 1 y 10, cual crees que tengo?: '))
...
- Intentos restantes: {intentos}""")
        # En caso de acertar, nos felicita
            ...
            break
    # En caso de quedar sin intentos nos da un aviso y nos revela el número que tenia
    if(intentos == 0):
        print(f"""- {nombre}, te has quedado sin intentos!
- El número que tenía era el {numero}""")
    # Si aun quedan intentos, despues de contestar nos avisa cuantos nos quedan
    else:
